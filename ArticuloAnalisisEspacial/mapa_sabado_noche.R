...
hurto_sabado_noche <- hurto_pereira_barrio_comuna_data_set_tbl %>%
  select(dia_formato,nombre_comuna,barrio,hurto_interval,hora_format_POSIXct) %>%
  filter(dia_formato=="Sabado", hurto_interval=="18-00") %>%
...
mapa_hurto_pereira_comuna_barrio <- merge(mapa_pereira_comuna_barrio,hurto_sabado_noche,by.x="nombre", by.y="nombre_comuna",  duplicateGeoms=TRUE)
