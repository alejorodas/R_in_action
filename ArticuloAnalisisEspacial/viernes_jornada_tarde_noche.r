...
hurtos_tarde_viernes <- new_data_set %>% 
...
ggplot(hurtos_tarde_viernes,aes(hora_format_POSIXct,num_hurtos)) +
  geom_line(aes(color=hurto_interval)) +
  xlab("Hora del Dia") +
  #labs(x="Hora del Dia",y="Cantidad de Hurtos") +
  scale_y_continuous("Cantidad de Hurtos",breaks = c(3,6,9,13), limits = c(1,13)) +
  scale_color_discrete("Jornada",labels=c("Tarde","Noche")) +
  ggtitle("Hurtos Dia Viernes Jornada Tarde (12-18) Noche (18-00)") +
