...
data.set.hurto.noche <- subset(hurto.pereira.comuna.barrio, hurto.inverval == "12-18" & Dia == "Sabado", select = !myvars)
...
plot(mytable, type = "b", las=2,
     ...
     xlab = "",
     main = "Hurto de Celulares en Jornada Tarde en el D??a S??bado",
     col="red",
     pch=15,
     lty=1)